...
perc_sellers=10 #Percentage sellers indicate that out of 500 agents 10% or 20% are sellers: 10% sellers = 50 sellers and 450 buyers. These correspond to the dr_num variable -> 10%,20%,...,90% of sellers ==50,100,...,450
...
dr_num=50 # if 50, agents 1-50 are sellers, and 51-500 are buyers #we could instead create a distribution that follows a series of climatic shocks, calibrated from real data.
...
a_once=500 #  determining the number of agents?
for ii in range(2): #what does this iteration tick do? # why 500?
